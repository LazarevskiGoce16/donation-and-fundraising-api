...
ALTER TABLE campaign ALTER COLUMN id RESTART WITH 2;
...
ALTER TABLE donor ALTER COLUMN id RESTART WITH 3;
...
ALTER TABLE donation ALTER COLUMN id RESTART WITH 3;
...
ALTER TABLE receipt ALTER COLUMN id RESTART WITH 3;
...
ALTER TABLE audit_log ALTER COLUMN id RESTART WITH 3;